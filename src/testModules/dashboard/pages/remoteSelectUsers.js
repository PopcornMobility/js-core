...
const remoteSearchPoprideOptionsClient = {
  filterOption: false,
  mode: "multiple",
  paramSearchQuery: "search",
  async apiFn(params) {
    ...
    const token = token_popride;
    const url = new URL(API_POPRIDE);
...
const remoteSearchPoprideOptionsDriver = {
  filterOption: false,
  mode: "multiple",
  paramSearchQuery: "search",
  async apiFn(params) {
        ...
        items: [
          {
            ...
            type: "remoteSelect",
            remoteSearch: remoteSearchPoprideOptionsClient,
            options: someOptions
          ...
          },
          {
            ...
            type: "remoteSelect",
            remoteSearch: remoteSearchPoprideOptionsDriver,
            options: someOptions
